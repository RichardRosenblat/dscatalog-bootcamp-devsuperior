        ...
        <div className="card-base product-card-admin">
            <div className="row">
                ...
                <div className='col-3 pt-3 pr-5'>
                    <button 
                        type="button" className="btn btn-outline-secondary btn-block border-radius-10 mb-3 btn-edit"
                    >
                        EDITAR
                    </button>
                    <button 
                        type="button" className="btn btn-outline-danger btn-block border-radius-10"
                    >
                        EXCLUIR
                    </button>
                </div>
